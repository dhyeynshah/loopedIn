...
import { loginWithGoogle, loginWithEmail, signInWithOTP, verifyOTP } from "@/lib/auth";
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 px-4 sm:px-0">
      <div className="w-full max-w-md p-8 bg-white shadow-lg rounded-lg">
        <h1 className="text-2xl font-bold text-center mb-6">Welcome to LoopedIn</h1>
        ...
        <div className="mt-6 text-center space-y-3">
          <p className="text-sm text-gray-600">
            ...
            <a href="/signup" className="text-[#60A5FA] hover:text-[#3B82F6]">Sign up</a>
          </p>
          <p className="text-sm text-gray-600">
